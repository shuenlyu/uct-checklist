...
export const survey1Results = [
  {
    ...
    satisfaction: 5,
    "recommend friends": 5,
    suggestions: "I am happy!",
    "price to competitors": "Not sure",
    price: "low",
    pricelimit: { mostamount: "100", leastamount: "100" },
  },
  {
    Quality: {
      affordable: "3",
    ...
    "price to competitors": "Not sure",
    price: "high",
    pricelimit: { mostamount: "60", leastamount: "10" },
  },
];
            ...
            elements: [
              {
                ...
                visible: false,
                visibleIf:
                  "{member_type_of_employment} contains 'Other types of employment'",
              },
              {
                type: "panel",
                elements: [
...
export const survey2Results = [
  {
    member_array_employer: [{}],
    partner_array_employer: [{}],
    maritalstatus_c: "Married",
    member_receives_income_from_employment: "0",
    partner_receives_income_from_employment: "0",
  },
  {
    member_array_employer: [{}],
    partner_array_employer: [{}],
    maritalstatus_c: "Single",
    member_receives_income_from_employment: "1",
    member_type_of_employment: ["Self employment"],
    member_seasonal_intermittent_or_contract_work: "0",
  },
];
